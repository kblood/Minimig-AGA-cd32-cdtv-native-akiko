...
// A DMA address the router does not claim must never fall through to the chip
// bus: the top 8 bits are absent there, so it would alias onto low chip RAM and
// silently overwrite the exception vectors. Complete the cycle, drive nothing.
